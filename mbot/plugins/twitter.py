...
async def twitter_handler(Mbot, message):
   try:            
      ...
      try:
          dump_file = await message.reply_video(link,caption="Thank you for using Join our movies and kdrama channel - @Entertainment_AG")
          ...
          try:
             ...
             await snd_message.delete()
              ...
              try:
                  dump_file = await message.reply_video(content_value,caption="Thank you for using Join our movies and kdrama channel - @Entertainment_AG")
              except Exception as e:
                  print(e)
                  try:
                     snd_msg=await message.reply(content_value)
                     await asyncio.sleep(1)
                     await message.reply_video(content_value,caption="Thank you for using Join our movies and kdrama channel - @Entertainment_AG")
